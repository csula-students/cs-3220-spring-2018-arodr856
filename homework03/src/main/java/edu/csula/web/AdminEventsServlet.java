...
public class AdminEventsServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// out.println(" <a href=\"LogOut\" class=\"nav-item\" id='logout'>Log
		// out</a>");
		//
		// out.println(" </nav>");
		// out.println("</div>");
		...
		// out.println(" <form class=\"event-form\" action=\"events\"
		// method=\"post\">");
		// out.println(" <label for=\"eventName\">Event Name:</label>");
		// out.println(" <input type=\"text\" name=\"name\" id=\"eventName\"
		// class=\"form-input\">");
		// out.println("<label for=\"eventDescription\">Event Description</label>");
		// out.println("<textarea id=\"eventDescription\"
		// name=\"descTextArea\"></textarea>");
		// out.println("<label for=\"trigger\">Trigger at:</label>");
		// out.println("<input type=\"number\" name=\"triggerInput\" id=\"trigger\"
		// class=\"form-input\">");
